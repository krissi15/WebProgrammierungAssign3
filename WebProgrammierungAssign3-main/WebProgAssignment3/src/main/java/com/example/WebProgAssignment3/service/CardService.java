...
public class CardService {
    ...
    private Integer TextCardMultipleChoiceAnzahl;
    ...
    public CardService() {
        ...
        this.TextCardMultipleChoiceAnzahl = 0;
    ...
    public SingleChoiceCard createSingleChoiceTextCard(String question, List<String> answers, Integer rightAnswer) {
        SingleChoiceCard singleChoiceCard = new SingleChoiceCard(TextCardSingleChoiceAnzahl++, question, answers, rightAnswer);
    ...
    public MultipleChoiceCard createMultipleChoiceTextCard(String question, List<String> answers, List<Integer> rightAnswers) {
        MultipleChoiceCard multipleChoiceCard = new MultipleChoiceCard(TextCardMultipleChoiceAnzahl++, question, answers, rightAnswers);
